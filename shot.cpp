...
void CShot::move(){
  ...
  {
    m_fyPos -= sin((90-m_fviewDirection)* M_PI/180)*m_fspeed;
    m_fxPos += cos((90-m_fviewDirection)* M_PI/180)*m_fspeed;
  }
  if(m_fviewDirection>=90&&m_fviewDirection<180)
  {
    m_fyPos += sin((m_fviewDirection-90)* M_PI/180)*m_fspeed;
    m_fxPos += cos((m_fviewDirection-90)* M_PI/180)*m_fspeed;
  }
  if(m_fviewDirection>=180&&m_fviewDirection<270)
  {
    m_fyPos += sin((270-m_fviewDirection)* M_PI/180)*m_fspeed;
    m_fxPos -= cos((270-m_fviewDirection)* M_PI/180)*m_fspeed;
  }
  if(m_fviewDirection>=270&&m_fviewDirection<360)
  {
    m_fyPos -= sin((m_fviewDirection-270)* M_PI/180)*m_fspeed;
    m_fxPos -= cos((m_fviewDirection-270)* M_PI/180)*m_fspeed;
  }
}
